...
public class SearchPage {
	...
	public void usuarioIngresaCiudadOrigen(String origen) throws InterruptedException {
		...
		driver.findElement(By.xpath(
				"//*[@id=\"searchbox-sbox-all-boxes\"]/div/div/div/div/div/div/div/div/div/div/div/div/input[@placeholder='Ingresa desde dónde viajas']"))
				.clear();
		driver.findElement(By.xpath(
				"//*[@id=\"searchbox-sbox-all-boxes\"]/div/div/div/div/div/div/div/div/div/div/div/div/input[@placeholder='Ingresa desde dónde viajas']"))
				.sendKeys(origen);
	...
	public void usuarioIngresaCiudadDestino(String destino) throws InterruptedException {
		...
		driver.findElement(By.xpath(
				"//*[@id=\"searchbox-sbox-all-boxes\"]/div/div/div/div/div/div/div/div/div/div/div/div/div/input[@placeholder='Ingresa hacia dónde viajas']"))
				.clear();
		driver.findElement(By.xpath(
				"//*[@id=\"searchbox-sbox-all-boxes\"]/div/div/div/div/div/div/div/div/div/div/div/div/div/input[@placeholder='Ingresa hacia dónde viajas']"))
				.sendKeys(destino);
